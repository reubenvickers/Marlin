 ...
 */
#define E0_AUTO_FAN_PIN P2_04 //RV  //#change
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define SHOW_BOOTSCREEN                 // Show the Marlin bootscreen on startup. ** ENABLE FOR PRODUCTION **
    ...
    #define BOOTSCREEN_TIMEOUT 3000       // (ms) Total Duration to display the boot screen(s)
      ...
      #define SHOW_CUSTOM_BOOTSCREEN    // Show the bitmap in Marlin/_Bootscreen.h on startup. //#change
    #endif
  #endif

  #if HAS_MARLINUI_U8GLIB
    #define CUSTOM_STATUS_SCREEN_IMAGE  // Show the bitmap in Marlin/_Statusscreen.h on the status screen. //#change
  #endif
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_SORT_ALPHA //RV //#change
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       760        // (mA) RMS current. Multiply by 1.414 for peak current. //#change
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) //#change
