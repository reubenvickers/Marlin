...
#define STRING_CONFIG_H_AUTHOR "(Reuben, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HyperCube v2.2b"
...
// Nema-17 motor: 1.8deg angle
// Z axis leadscrew: T8x8: 8mm pitch
// XY axis: 20 teeth pulley, GT2 2mm belt
